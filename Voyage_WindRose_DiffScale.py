...
rect_2 = [0.225, 0.7, 0.225, 0.225]     # [left, bottom, width, height]
...
rect_3 = [0.45, 0.7, 0.225, 0.225]     # [left, bottom, width, height]
...
rect_4 = [0.675, 0.7, 0.225, 0.225]     # [left, bottom, width, height] as a fraction of total figure size
...
rect_6 = [0.225, 0.375, 0.225, 0.225]     # [left, bottom, width, height]
...
rect_7= [0.45, 0.375, 0.225, 0.225]     # [left, bottom, width, height]
...
rect_8 = [0.675, 0.375, 0.225, 0.225]     # [left, bottom, width, height] as a fraction of total figure size
...
rect_9 = [0.225, 0.05, 0.225, 0.225]     # [left, bottom, width, height]
...
rect_10 = [0.45, 0.05, 0.225, 0.225]     # [left, bottom, width, height]
