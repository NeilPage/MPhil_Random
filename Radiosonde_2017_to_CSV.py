...
TempDry   = TempDry.dropna()
WindSpeed = WindSpeed.dropna()
WindDir   = WindDir.dropna()
RelHum    = RelHum.dropna()
EastWind  = EastWind.dropna()
NorthWind = NorthWind.dropna()

# Filter the DataFrames to only include values across all DataFrames
Altitude  = Altitude[Altitude.index.isin(WindSpeed.index)]
Pressure = Pressure[Pressure.index.isin(WindSpeed.index)]
TempDry   = TempDry[TempDry.index.isin(WindSpeed.index)]
RelHum    = RelHum[RelHum.index.isin(WindSpeed.index)]
...
# pbl 1
Time1   = IndexTime[0:77]
z1      = z[0:77]
thetav1 = thetaV[0:77]
ws1     = ws[0:77]

# pbl 2
Time2   = IndexTime[78:389]
z2      = z[78:389]
thetav2 = thetaV[78:389]
ws2     = ws[78:389]
...
dfV1_17.to_csv('/Users/ncp532/Documents/Data/MERRA2/CAMMPCAN_2017_Radiosonde.csv')
