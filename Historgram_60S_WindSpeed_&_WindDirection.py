...
# V1----------------
# Wind Direction
WD_s1_17 = np.array(V1_17_60S['WND_DIR_STRBD_CORR_DEG']) # starboard side wind direction (correlated)
WD_p1_17 = np.array(V1_17_60S['WND_DIR_PORT_CORR_DEG']) # port side wind direction (correlated)
# Wind Speed
WS_s1_17 = np.array(V1_17_60S['WND_SPD_STRBD_CORR_KNOT']) # starboard side wind speed (correlated)
WS_s1_17 = WS_s1_17 * 0.514444444 # Convert from knots to m/s
WS_p1_17 = np.array(V1_17_60S['WND_SPD_PORT_CORR_KNOT']) # port side wind speed (correlated)
...
# Build DatFrame of WindDirection & WindSpeed
...
# V2----------------
# Wind Direction
WD_s2_17 = np.array(V2_17_60S['WND_DIR_STRBD_CORR_DEG']) # starboard side wind direction (correlated)
WD_p2_17 = np.array(V2_17_60S['WND_DIR_PORT_CORR_DEG']) # port side wind direction (correlated)
# Wind Speed
WS_s2_17 = np.array(V2_17_60S['WND_SPD_STRBD_CORR_KNOT']) # starboard side wind speed (correlated)
WS_s2_17 = WS_s2_17 * 0.514444444 # Convert from knots to m/s
WS_p2_17 = np.array(V2_17_60S['WND_SPD_PORT_CORR_KNOT']) # port side wind speed (correlated)
...
# V3----------------
# Wind Direction
WD_s3_17 = np.array(V3_17_60S['WND_DIR_STRBD_CORR_DEG']) # starboard side wind direction (correlated)
WD_p3_17 = np.array(V3_17_60S['WND_DIR_PORT_CORR_DEG']) # port side wind direction (correlated)
# Wind Speed
WS_s3_17 = np.array(V3_17_60S['WND_SPD_STRBD_CORR_KNOT']) # starboard side wind speed (correlated)
WS_s3_17 = WS_s3_17 * 0.514444444 # Convert from knots to m/s
WS_p3_17 = np.array(V3_17_60S['WND_SPD_PORT_CORR_KNOT']) # port side wind speed (correlated)
...
# V1----------------
# Wind Direction
WD_s1_18 = np.array(V1_18_60S['WND_DIR_STRBD_CORR_DEG']) # starboard side wind direction (correlated)
WD_p1_18 = np.array(V1_18_60S['WND_DIR_PORT_CORR_DEG']) # port side wind direction (correlated)
# Wind Speed
WS_s1_18 = np.array(V1_18_60S['WND_SPD_STRBD_CORR_KNOT']) # starboard side wind speed (correlated)
WS_s1_18 = WS_s1_18 * 0.514444444 # Convert from knots to m/s
WS_p1_18 = np.array(V1_18_60S['WND_SPD_PORT_CORR_KNOT']) # port side wind speed (correlated)
...
# V2----------------
# Wind Direction
WD_s2_18 = np.array(V2_18_60S['WND_DIR_STRBD_CORR_DEG']) # starboard side wind direction (correlated)
WD_p2_18 = np.array(V2_18_60S['WND_DIR_PORT_CORR_DEG']) # port side wind direction (correlated)
# Wind Speed
WS_s2_18 = np.array(V2_18_60S['WND_SPD_STRBD_CORR_KNOT']) # starboard side wind speed (correlated)
WS_s2_18 = WS_s2_18 * 0.514444444 # Convert from knots to m/s
WS_p2_18 = np.array(V2_18_60S['WND_SPD_PORT_CORR_KNOT']) # port side wind speed (correlated)
...
# V3----------------
# Wind Direction
WD_s3_18 = np.array(V3_18_60S['WND_DIR_STRBD_CORR_DEG']) # starboard side wind direction (correlated)
WD_p3_18 = np.array(V3_18_60S['WND_DIR_PORT_CORR_DEG']) # port side wind direction (correlated)
# Wind Speed
WS_s3_18 = np.array(V3_18_60S['WND_SPD_STRBD_CORR_KNOT']) # starboard side wind speed (correlated)
WS_s3_18 = WS_s3_18 * 0.514444444 # Convert from knots to m/s
WS_p3_18 = np.array(V3_18_60S['WND_SPD_PORT_CORR_KNOT']) # port side wind speed (correlated)
...
# PCAN (2017)--------
# Wind Direction
WD_sPCAN = np.array(PCAN_60S['Starboard True Wind Direction (degree)']) # starboard side wind direction (correlated)
WD_pPCAN = np.array(PCAN_60S['Port True Wind Direction (degree)']) # port side wind direction (correlated)
# Wind Speed
WS_sPCAN = np.array(PCAN_60S['Starboard True Wind Speed (knot)']) # starboard side wind speed (correlated)
WS_sPCAN = WS_sPCAN * 0.514444444 # Convert from knots to m/s
WS_pPCAN = np.array(PCAN_60S['Port True Wind Speed (knot)']) # port side wind speed (correlated)
...
# SIPEXII (2012)----
# Wind Direction
WD_sSIP = np.array(SIPEXII_60S['WND_DIR_STRBD_CORR_DEG']) # starboard side wind direction (correlated)
WD_pSIP = np.array(SIPEXII_60S['WND_DIR_PORT_CORR_DEG']) # port side wind direction (correlated)
# Wind Speed
WS_sSIP = np.array(SIPEXII_60S['WND_SPD_STRBD_CORR_KNOT']) # starboard side wind speed (correlated)
WS_sSIP = WS_sSIP * 0.514444444 # Convert from knots to m/s
WS_pSIP = np.array(SIPEXII_60S['WND_SPD_PORT_CORR_KNOT']) # port side wind speed (correlated)
