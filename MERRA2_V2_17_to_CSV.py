...
# A1
A1_V1_17   = xr.open_mfdataset('/Users/ncp532/Documents/Data/MERRA2/V2_17/MERRA2.201*.A1.2x25.nc4', combine='by_coords') # A1 Fields

# A3
A3_V1_17   = xr.open_mfdataset('/Users/ncp532/Documents/Data/MERRA2/V2_17/MERRA2.201*.A3dyn.2x25.nc4', combine='by_coords') # A3dyn Fields

# I3
I3_V1_17   = xr.open_mfdataset('/Users/ncp532/Documents/Data/MERRA2/V2_17/MERRA2.201*.I3.2x25.nc4', combine='by_coords') # I3 Fields
...
#----------------------------------
# A1
Time_V1_17       = A1_V1_17.time[1:813].values           # DateTime (YYYY-MM_DD HH:MM:SS)
PrecTot_V1_17    = A1_V1_17.PRECTOT[1:813,13,116].values # Total precipitation (kg/m2/s)
PrecSno_V1_17    = A1_V1_17.PRECSNO[1:813,13,116].values # Snowfall (kg/m2/s)
Rainfall_V1_17   = PrecTot_V1_17 - PrecSno_V1_17          # Rainfall (kg/m2/s)
SLP_V1_17        = A1_V1_17.SLP[1:813,13,116].values     # Sea level pressure (Pa)
Temp2m_V1_17     = A1_V1_17.T2M[1:813,13,116].values     # 2m air temperature (K)
Temp10m_V1_17    = A1_V1_17.T10M[1:813,13,116].values    # 10m air temperature (K)
QV2m_V1_17       = A1_V1_17.QV2M[1:813,13,116].values    # 2m specific humidity (kg/kg)
EWind10m_V1_17   = A1_V1_17.U10M[1:813,13,116].values    # 10m eastward wind (m/s)
NWind10m_V1_17   = A1_V1_17.V10M[1:813,13,116].values    # 10m northward wind (m/s)
WS10m_V1_17      = np.sqrt(EWind10m_V1_17**2
                           + NWind10m_V1_17**2)           # 10m wind speed (m/s)
# I3
Time2_V1_17      = I3_V1_17.time[1:813].values           # DateTime (YYYY-MM_DD HH:MM:SS)
Temp_V1_17       = np.array(Temp_V1_17)[1:813,:]         # Air temperature (K)
PS_V1_17         = np.array(PS_V1_17)[1:813]             # Surface pressure (Pa)

# A3dyn
Time3_V1_17      = A3_V1_17.time[0:812].values           # DateTime (YYYY-MM_DD HH:MM:SS)
RH_V1_17         = np.array(RH_V1_17)[0:812,:]           # Relative humidity (1)
EWind_V1_17      = np.array(EWind_V1_17)[0:812,:]        # Eastward wind (m/s)
NWind_V1_17      = np.array(NWind_V1_17)[0:812,:]        # Northward wind (m/s)
...
dfV1_17.to_csv('/Users/ncp532/Documents/Data/MERRA2/V2_17_MERRA2.csv')
